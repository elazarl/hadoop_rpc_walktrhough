...
var clientInput = []byte{
	...
	0x09, 0x00, 0x00,
	// size of next two size delimited protobuf objets: RpcRequestHeader and IpcConnectionContext
	...
	// Size of size delimited RpcRequestHeader + RpcRequest protobuf objects
